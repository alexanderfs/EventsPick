...
public class ContactListActivity extends SherlockActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_add: {
			Intent i = new Intent(this, FriendAddActivity.class);
			startActivity(i);
			return true;
		}
		}
	...
	private void initView() {
		...
		vList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i = new Intent(ContactListActivity.this, FriendInfoActivity.class);
				startActivity(i);
			}
		});
		
		List<DBFriend> df = DBHelper.getInstance(ContactListActivity.this).getFriendDao().queryBuilder()
				.where(DBFriendDao.Properties.UserID.eq(userID)).list();
